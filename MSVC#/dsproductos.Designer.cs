...
namespace MundoMusical.DB.DATA_SET {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class productoDataTable : global::System.Data.TypedTableBase<productoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public productoRow AddproductoRow(int idcategoria, string nombre, string precio, int stock, int idproducto) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public productoRow FindBypkproducto(int pkproducto) {
        ...
        public partial class productoRow : global::System.Data.DataRow {
            ...
            public int pkproducto {
                get {
                    return ((int)(this[this.tableproducto.pkproductoColumn]));
                }
                set {
                    this[this.tableproducto.pkproductoColumn] = value;
                }
            }
...
namespace MundoMusical.DB.DATA_SET.DataSet1TableAdapters {
    ...
    public partial class productoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `producto` WHERE ((`pkproducto` = @p1) AND (`idcategoria` = @p2) AND " +
                "(`nombre` = @p3) AND (`precio` = @p4) AND (`stock` = @p5) AND (`idproducto` = @p" +
                "6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `producto` (`idcategoria`, `nombre`, `precio`, `stock`, `idproducto`)" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `producto` SET `idcategoria` = @p1, `nombre` = @p2, `precio` = @p3, `stock" +
                "` = @p4, `idproducto` = @p5 WHERE ((`pkproducto` = @p6) AND (`idcategoria` = @p7" +
                ") AND (`nombre` = @p8) AND (`precio` = @p9) AND (`stock` = @p10) AND (`idproduct" +
                "o` = @p11))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MundoMusical.Properties.Settings.Default.puntodeventaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `pkproducto`, `idcategoria`, `nombre`, `precio`, `stock`, `idproducto` FRO" +
                "M `producto`";
